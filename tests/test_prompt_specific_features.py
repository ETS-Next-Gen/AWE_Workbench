...
from awe_workbench.parser.components.contentSegmentation import *
...
holmes_manager.process_with_prompt(text, label, prompt, prompt_label)
...
class PromptSpecificFeatureTest(unittest.TestCase):
    ...
    def test_content_segments(self):
        ...
        content_segments = [[0, 37, [[10, 15], [28, 29], [12], [16]]], [52, 68, [[65, 66], [54], [59], [61]]], [68, 114, [[82, 105, 106], [87, 92, 109, 110], [77], [84], [85], [93], [99], [100], [103], [108], [112]]], [175, 223, [[187, 205], [189, 192, 193, 210], [208, 214], [197], [207]]], [252, 269, [[255, 257], [253], [260], [265], [267]]], [309, 393, [[325, 336, 337, 354], [344, 348], [352, 363], [357, 359, 368, 372], [369, 373, 391], [315], [321], [322], [326], [330], [331], [333], [334], [349], [356], [365], [376], [389]]], [411, 470, [[414, 421, 435], [436, 439, 452], [438, 451, 467], [442, 446], [444, 455], [456, 463], [415], [418], [431], [434], [441], [445], [450], [457], [462], [468]]], [470, 527, [[482, 490], [484, 485], [493, 494, 522, 525], [502, 503, 504, 513], [511, 518], [521, 524], [472], [477], [495], [498], [505], [509], [515], [516], [519]]], [561, 622, [[565, 566], [572, 577, 591, 603, 615, 620], [564], [569], [570], [575], [580], [596], [608], [609], [611], [617], [618]]]]
        self.assertEqual(doc._.content_segments,content_segments)
        
    def test_prompt_related(self):
        doc = holmes_manager.get_document('GRE_Sample_Essay')      
        prompt_related = [[14, 3.6747192922762837, ['technology', 'emerge', 'market', 'nanotechnology'], [3, 46, 161, 212, 229, 247, 286, 307, 333, 334, 405, 537, 552, 589, 606, 623, 640, 695]], [51, 2.7333009865760953, ['thinking', 'assumption', 'argue', 'hypothetical', 'think', 'fact', 'consider', 'layman', 'actually', 'imagine'], [7, 154, 183, 196, 216, 284, 411, 459, 468, 538, 561, 594, 598]], [33, 2.6008002462296087, ['human', 'earth', 'humanity'], [11, 112, 147, 239, 277, 288, 408, 545, 579, 595, 628, 647, 701]], [35, 1.7955112219451372, ['reliance', 'negate', 'preclude'], [159, 162, 227, 233, 273, 550]], [5, 1.5203226807322372, ['utilize', 'ability', 'convenience', 'provide', 'complete'], [108, 145, 250, 531, 539, 569, 696]], [22, 1.5081563558017852, ['quandary', 'problem', 'issue', 'concern'], [173, 220, 294, 301, 340, 382, 659]], [58, 0.898876404494382, ['surely', 'necessarily', 'exist', 'likewise'], [18, 232, 305, 351]], [23, 0.6751687921980495, ['solve', 'demand', 'solution'], [171, 331, 378]]]
        self.assertEqual(doc._.prompt_related,prompt_related)
        
    def test_prompt_language(self):
        doc = holmes_manager.get_document('GRE_Sample_Essay')      
        prompt_language = ['people', 'rely', 'technology', 'solve', 'problem', 'ability', 'human', 'think', 'surely', 'deteriorate', 'thinking', 'reliance', 'humanity', 'solution']
        self.assertEqual(doc._.prompt_language,prompt_language)

    def test_core_sentences(self):
        doc = holmes_manager.get_document('GRE_Sample_Essay')      
        core_sentences = [[0, 18], [18, 37], [132, 153], [153, 175], [212, 223], [224, 242], [269, 283], [283, 309], [378, 393], [394, 411], [528, 547], [547, 561], [623, 642], [642, 671], [671, 704]]
